...
showGroupingControls | boolean | false | If true, it renders a component that toggles a column's grouping state
...
showGroupingControls | boolean | If true, a component that toggles a column's grouping state is rendered
