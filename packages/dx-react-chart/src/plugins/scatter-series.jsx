import { coordinates as computeCoordinates, getStartCoordinates, scatterAnimation } from '@devexpress/dx-chart-core';
...
export const ScatterSeries = withComponents({ Path, Point })(makeSeries(
  ...
  computeCoordinates,
  { getStartCoordinates, animationOptions: scatterAnimation() },
  {
