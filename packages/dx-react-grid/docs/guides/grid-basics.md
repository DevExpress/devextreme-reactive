...
Note that we use the `Table.Row` component to render a table row. Refer to the [Plugin Components](../reference/table.md#plugin-components) section to read more abour Table's components.
