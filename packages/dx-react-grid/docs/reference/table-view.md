...
allowColumnReordering | boolean | false | If true, it allows end-users to change the column's order by dragging it. Requires the [TableColumnReordering](table-column-reordering.md) and the [DragDropContext](drag-drop-context.md) dependencies.
