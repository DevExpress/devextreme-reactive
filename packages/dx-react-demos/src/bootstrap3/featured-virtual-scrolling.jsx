...
export const FeaturedVirtualScrollingDemos = () => (
  <div>
    ...
    <p>
      Virtual scrolling mode is an alternative to data paging. It allows end users to navigate
      the data rows by using its vertical scrollbar. In this demo, the DataGrid is bound to 200,000
      records and virtual scrolling is enabled by using the VirtualTableView plugin.
    </p>
