...
-----|------|---------|------------
getColumnIdentity | (columnName: string) => [Identity](#identity) &#124; undefined | | A function that defines a column's grouping identity. See [Grouping](../guides/grouping.md#built-in-grouping-with-custom-values) for details.
