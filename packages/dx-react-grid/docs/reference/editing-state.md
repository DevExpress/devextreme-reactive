...
onEditingRowsChange | (editingRows: Array&lt;number &#124; string&gt;) => void | | Handles adding a row to or removing from the `editingRows` array
addedRows | Array&lt;Object&gt; | | Specifies the created but not commited rows
defaultAddedRows | Array&lt;Object&gt; | | Specifies rows initially added to the `addedRows` array in the uncontrolled mode
onAddedRowsChange | (addedRows: Array&lt;Object&gt;) => void | | Handles adding a row to or removing from the `addedRows` array
...
startEditRows | Action | ({ rowIds: Array&lt;number &#124; string&gt; }) => void | Switches rows specified by ID to the edit mode
stopEditRows | Action | ({ rowIds: Array&lt;number &#124; string&gt; }) => void | Switches rows specified by ID to the read-only mode
...
cancelChangedRows | Action | ({ rowIds: Array&lt;number &#124; string&gt; }) => void | Cancels uncommitted changes of the rows specified by ID
...
deleteRows | Action | ({ rowIds: Array&lt;number &#124; string&gt; }) => void | Adds rows specified by ID to the `deletedRows` array
cancelDeletedRows | Action | ({ rowIds: Array&lt;number &#124; string&gt; }) => void | Cancels deletion of the rows specified by ID removing them from the `deletedRows` array
