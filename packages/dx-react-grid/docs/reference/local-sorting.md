...
-----|------|---------|------------
getColumnCompare | (columnName: string) => (a: any, b: any) => number | | A function implementing a custom sorting. For more information, see the [sorting guide](../guides/sorting.md#custom-sorting-algorithm).
