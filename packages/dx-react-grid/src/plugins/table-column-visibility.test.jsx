...
import { visibleTableColumns, getMessagesFormatter, columnChooserItems, toggleColumn, isEmptyMessageShown } from '@devexpress/dx-grid-core';
...
describe('TableColumnVisibility', () => {
  ...
  beforeEach(() => {
    ...
    isEmptyMessageShown.mockImplementation(() => true);
  });
  afterEach(() => {
    jest.resetAllMocks();
  });
