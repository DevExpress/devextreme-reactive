...
export interface DragDropProviderProps {
  ...
  sourceAppointmentComponent: React.ComponentType<DragDropProvider.SourceAppointmentProps  & { ref: React.Ref<unknown>}>;
  /** A component that renders a handle used to resize the appointment. */
  resizeComponent: React.ComponentType<DragDropProvider.ResizeProps  & { ref?: React.Ref<unknown>}>;
  /***
