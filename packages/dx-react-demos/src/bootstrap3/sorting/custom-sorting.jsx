...
export default class Demo extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      intergatedSortingColumnExtensions: [
  ...
  render() {
    const {
      rows, columns, intergatedSortingColumnExtensions, tableColumnExtensions,
    } = this.state;
    ...
    return (
      ...
      >
        <SortingState />
        <IntegratedSorting
          columnExtensions={intergatedSortingColumnExtensions}
        />
        <Table
