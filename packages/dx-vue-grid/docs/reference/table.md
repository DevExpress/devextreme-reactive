...
valueFormatter | Template | [DxDataTypeProvider.ValueFormatter](data-type-provider.md#dxdatatypeproviderdxvalueformatter) | A template that renders the formatted value.
