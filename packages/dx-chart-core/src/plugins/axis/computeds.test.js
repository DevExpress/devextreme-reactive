  ...
  describe('linear', () => {
    ...
    it('should return ticks Coordinates with horizontal-top position', () => {
      ...
      expect(coordinates).toEqual({
        ticks: [{
          xText: 25, yText: -15, text: 1, dominantBaseline: 'baseline', textAnchor: 'middle', y1: -5, y2: 0, x1: 10, x2: 10, key: 0,
        }],
      });
    });
    ...
    it('should return ticks coordinates with horizontal-bottom position', () => {
      ...
      expect(coordinates).toEqual({
        ticks: [{
          xText: 25, yText: 15, text: 1, dominantBaseline: 'hanging', textAnchor: 'middle', y1: 0, y2: 5, x1: 10, x2: 10, key: 0,
        }],
      });
    });
    ...
    it('should return ticks coordinates with vertical-left position', () => {
      ...
      expect(coordinates).toEqual({
        ticks: [{
          text: 1, xText: -15, yText: 25, x1: -5, x2: 0, y1: 10, y2: 10, dominantBaseline: 'middle', textAnchor: 'end', key: 0,
        }],
      });
    });
    ...
    it('should return ticks coordinates with vertical-right position', () => {
      ...
      expect(coordinates).toEqual({
        ticks: [{
          text: 1, xText: 15, yText: 25, x1: 0, x2: 5, y1: 10, y2: 10, dominantBaseline: 'middle', textAnchor: 'start', key: 0,
        }],
      });
    });
