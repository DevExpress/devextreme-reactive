...
describe('#getReadiness', () => {
  ...
  it('should return false, pane size is zero', () => {
    ...
    expect(getReadiness({ pane }, { current: {} }, false, false)).toBe(false);
  });
  ...
  it('should return false, div size is not equal size of elements inside', () => {
    ...
    expect(getReadiness({ pane }, divRef, false, false)).toBe(false);
    expect(getReadiness({
      pane,
  ...
  it('should return true, div size is equal size of elements inside', () => {
    ...
    expect(getReadiness({ pane: { width: 300, height: 400 } }, divRef, false, false)).toBe(true);
    expect(getReadiness({
